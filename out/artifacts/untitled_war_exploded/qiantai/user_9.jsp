               ...
               <div class="user_coment">
                  <table width="713" border="0" cellspacing="0" cellpadding="0"  class="my_dd">
                       <tr>
                            ...
                            <th width="98">发件人</th>
                            <th width="117">时间</th>
                           <th height="48" width="117">订单编号</th>
                            <th width="115">操作</th>
                        </tr>
                       ...
                       <c:forEach items="${olist}" var="o">
                        <tr>
                            ...
                            <td colspan="2">${o.books.book_name}退货成功</td>
                            <td>系统信息</td>
                            <td  width="177">${o.order_date}</td>
                            <td width="117" height="48">${o.order_number}</td>
                            <td width="115">
                                <a href="${pageContext.request.contextPath}/XinXiChaKanServlet?ye=${ye}&number=${o.order_number}&name=${o.books.book_name}" style="padding-right:6px;">查看</a>
                            </td>
                        </tr>
                       </c:forEach>
                    </table>
                 ...
                 <div style="clear:both;"></div>
                    <div class="fenyeys" >
                        <c:if test="${ye<=1}">
                        <a href="XiTongXinXiServlet?ye=${ye-1}" style="pointer-events:none">上一页</a>
                        </c:if>
                        <c:if test="${ye>1}">
                            <a href="XiTongXinXiServlet?ye=${ye-1}">上一页</a>
                        </c:if>
                        ${ye}/${count}
                        <c:if test="${ye>=count}">
                        <a href="XiTongXinXiServlet?ye=${ye+1}" style="pointer-events:none">下一页</a>
                        </c:if>
                        <c:if test="${ye<count}">
                            <a href="XiTongXinXiServlet?ye=${ye+1}" >下一页</a>
                        </c:if>
                    </div>
                    <div style="clear:both;"></div>
                    <!--分页结束 -->
