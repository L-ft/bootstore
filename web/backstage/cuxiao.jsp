...
<div class="wangid_conbox">
	...
	<!-- 筛选 -->
	<div class="shuaix">
		<form action="${pageContext.request.contextPath}/FindLikeCuxiaoBook" method="post">
			<div class="right">
	...
	<table class="layui-table" lay-filter="mylist" lay-size="lg">
		...
		<c:forEach items="${books}" var="book">
			...
			<tr>
				...
				<td>
					<a href="${pageContext.request.contextPath}/InsterCuxiao?id=${book.book_id}">查看</a>
					<a href="${pageContext.request.contextPath}/DeleteCuxiao?book_id=${book.book_id}">删除</a>
				</td>
			</tr>
